...
# and define them as environmental variables PARAM1-2 (PARAM are COLUMNS in lm0_3_param_chr22.txt)
# above #$ -t 1 (refers to the LINES in lm0_3_param_chr22.txt)

export $(head -$SGE_TASK_ID lm0_3_param_chr22.txt | tail -1 | awk 'BEGIN{ OFS=""; } {printf "PARAM1="; print $1; }')
