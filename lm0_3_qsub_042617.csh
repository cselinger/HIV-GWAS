...
# and define them as environmental variables PARAM1-2 (PARAM are COLUMNS in lm3_12_param.txt)
# above #$ -t 1-24 (refers to the LINES in lm3_12_param.txt)

export $(head -$SGE_TASK_ID lm3_12_param.txt | tail -1 | awk 'BEGIN{ OFS=""; } {printf "PARAM1="; print $1; }')
export $(head -$SGE_TASK_ID lm3_12_param.txt | tail -1 | awk 'BEGIN{ OFS=""; } {printf "PARAM2="; print $2; }')
